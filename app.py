...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Trình - Trường Tiểu Học Minh Quang - ĐT: 096 8962 567</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Trình - Trường Tiểu Học Minh Qunag - ĐT: 096 8962 567</div>", unsafe_allow_html=True)
